...
def main():
    ...
    parser.add_argument('--batch_size', '-b', type=int, default=200) #steps collected per train iteration
    ...
    parser.add_argument('--ep_len', type=int, default=1000) #students shouldn't change this away from env's default
